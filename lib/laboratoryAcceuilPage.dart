...
class laboratoryAcceuilPage extends StatelessWidget {
  @override
          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                    'assets/images/laboratory.jpg'), // Remplacez 'votre_image.jpg' par le chemin de votre image
                fit: BoxFit.cover,
              ),
            ),
          ),
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => LaboratoirePage()),
                  );
                },
                child: Container(
                  width: 50.0,
