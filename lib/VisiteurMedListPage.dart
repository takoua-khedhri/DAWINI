...
import 'VisiteurProfileMed.dart';


class VisiteurMedListPage extends StatefulWidget {
...
VisiteurMedListPage({
  ...
  @override
  _VisiteurMedListPageState createState() => _VisiteurMedListPageState();
}

class _VisiteurMedListPageState extends State<VisiteurMedListPage> {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => VisiteurProfileMed(
